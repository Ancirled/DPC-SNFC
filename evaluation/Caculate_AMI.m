...
function [AMI]=Caculate_AMI(true_labels,labels)
if nargin==1
    T=true_labels; %contingency table pre-supplied
elseif nargin==2
    ...
    list_t=ismember(1:R,true_labels);
    list_m=ismember(1:C,labels);
    T=Contingency(true_labels,labels);
    T=T(list_t,list_m);
end
